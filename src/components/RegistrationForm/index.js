...
class RegistrationForm extends Component {
  ...
  onClickSubmitAnotherResponse = () => {
    this.setState(prevState => ({isFormSubmitted: !prevState.isFormSubmitted,
      firstName: '',
      lastName: '',
    }))
  }
  ...
  renderSubmissionReport = () => (
    <>
      <img src="https://i.postimg.cc/FsN79g77/icon-g946d0c67f-1280.png" alt="success" className="success-image"/>
    ...
    return (
      <div className="registration-form-container">
        ...
        <div className="container">
          {isFormSubmitted ? this.renderSubmissionReport() : this.renderRegistrationForm()}
        </div>
      </div>
    )
  }
